...
//		passwordreg.getAttribute("validationMessage");
		...
		Boolean is_valid = (Boolean) js.executeScript("return arguments[0].checkValidity();", passwordreg);
		System.out.println("passowrd: " + is_valid + " message: " + passwordreg.getAttribute("required"));
	}
